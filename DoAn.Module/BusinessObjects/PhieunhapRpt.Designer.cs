namespace DoAn.Module.BusinessObjects
{
	partial class PhieunhapRpt
	{
		...
		private void InitializeComponent()
		{
			...
			// xrTable2
			// 
			this.xrTable2.LocationFloat = new DevExpress.Utils.PointFloat(0F, 148.9583F);
			this.xrTable2.Name = "xrTable2";
			this.xrTable2.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 96F);
			this.xrTable2.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow6});
			this.xrTable2.SizeF = new System.Drawing.SizeF(661.0202F, 20.83334F);
			// 
			// xrTableRow6
			// 
			...
			this.xrTableCell3.Weight = 0.40190189558568035D;
			// 
			// xrTableCell6
			// 
			...
			this.xrTableCell6.Text = "Tên sản phẩm";
			this.xrTableCell6.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopCenter;
			this.xrTableCell6.Weight = 3.3449550793694751D;
			// 
			// xrTableCell9
			// 
			...
			this.xrTableCell9.Weight = 0.76595024124735689D;
			// 
			// xrTableCell12
			// 
			...
			this.xrTableCell12.Weight = 0.66845383999371444D;
			// 
			// xrTableCell15
			// 
			...
			this.xrTableCell15.Weight = 1.1785253151867727D;
			// 
			// xrTableCell16
			// 
			...
			this.xrTableCell18.Weight = 1.1785242878238897D;
			// 
			// xrTable1
			// 
			this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(39.5833F, 47.29168F);
            ...
            this.xrTableRow4,
            this.xrTableRow5});
			this.xrTable1.SizeF = new System.Drawing.SizeF(600.4167F, 90.62498F);
			// 
			// xrTableRow1
			// 
			...
			this.xrTableCell1.Weight = 0.39278284418972942D;
			// 
			// xrTableCell2
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[SoCT]")});
			this.xrTableCell2.Multiline = true;
			this.xrTableCell2.Name = "xrTableCell2";
			this.xrTableCell2.StylePriority.UseBorderDashStyle = false;
			this.xrTableCell2.StylePriority.UseBorders = false;
			this.xrTableCell2.Text = "xrTableCell2";
			this.xrTableCell2.Weight = 1.6072171558102704D;
			// 
			// xrTableRow2
			// 
			...
			this.xrTableCell4.Weight = 0.39278284418972942D;
			// 
			// xrTableCell5
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[NgayCT]")});
			this.xrTableCell5.Multiline = true;
			this.xrTableCell5.Name = "xrTableCell5";
			this.xrTableCell5.StylePriority.UseBorderDashStyle = false;
			this.xrTableCell5.StylePriority.UseBorders = false;
			this.xrTableCell5.Text = "xrTableCell5";
			this.xrTableCell5.Weight = 1.6072171558102704D;
			// 
			// xrTableRow3
			// 
			...
			this.xrTableCell7.Weight = 0.39278284418972942D;
			// 
			// xrTableCell8
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Khach].[TenKH]")});
			this.xrTableCell8.Multiline = true;
			this.xrTableCell8.Name = "xrTableCell8";
			this.xrTableCell8.StylePriority.UseBorderDashStyle = false;
			this.xrTableCell8.StylePriority.UseBorders = false;
			this.xrTableCell8.Text = "xrTableCell8";
			this.xrTableCell8.Weight = 1.6072171558102704D;
			// 
			// xrTableRow4
			// 
			...
			this.xrTableCell10.Weight = 0.39278284418972942D;
			// 
			// xrTableCell11
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Khach].[DiaChi]")});
			this.xrTableCell11.Multiline = true;
			this.xrTableCell11.Name = "xrTableCell11";
			this.xrTableCell11.StylePriority.UseBorderDashStyle = false;
			this.xrTableCell11.StylePriority.UseBorders = false;
			this.xrTableCell11.Text = "xrTableCell11";
			this.xrTableCell11.Weight = 1.6072171558102704D;
			// 
			// xrTableRow5
			// 
			...
			this.xrTableCell13.Weight = 0.39278284418972942D;
			// 
			// xrTableCell14
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Khach].[DienThoai]")});
			this.xrTableCell14.Multiline = true;
			this.xrTableCell14.Name = "xrTableCell14";
			this.xrTableCell14.StylePriority.UseBorderDashStyle = false;
			this.xrTableCell14.StylePriority.UseBorders = false;
			this.xrTableCell14.Text = "xrTableCell14";
			this.xrTableCell14.Weight = 1.6072171558102704D;
			// 
			// xrLabel1
			// 
			...
			this.xrLabel1.SizeF = new System.Drawing.SizeF(345.8333F, 27.08334F);
			this.xrLabel1.StylePriority.UseFont = false;
			this.xrLabel1.StylePriority.UseTextAlignment = false;
			this.xrLabel1.Text = "PHIẾU NHẬP";
			...
			this.collectionDataSource1.ObjectTypeName = "DoAn.Module.BusinessObjects.PhieuNhap";
            ...
            this.Detail1});
			this.DetailReport.DataMember = "DongNhaps";
            ...
            this.xrTable3});
			this.Detail1.HeightF = 20.83334F;
            ...
            this.xrTableRow7});
			this.xrTable3.SizeF = new System.Drawing.SizeF(661.0202F, 20.83334F);
			// 
			// xrTableRow7
			// 
			...
			this.xrTableCell19.Weight = 0.40190189558568035D;
			// 
			// xrTableCell20
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Hang].[TenSP]")});
			this.xrTableCell20.Multiline = true;
			this.xrTableCell20.Name = "xrTableCell20";
			this.xrTableCell20.StylePriority.UseBorders = false;
			this.xrTableCell20.StylePriority.UseTextAlignment = false;
			this.xrTableCell20.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
			this.xrTableCell20.Weight = 3.3449550793694751D;
			// 
			// xrTableCell21
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Hang].[Dvt]")});
			this.xrTableCell21.Multiline = true;
			this.xrTableCell21.Name = "xrTableCell21";
			this.xrTableCell21.StylePriority.UseBorders = false;
			this.xrTableCell21.StylePriority.UseTextAlignment = false;
			this.xrTableCell21.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopCenter;
			this.xrTableCell21.Weight = 0.76595024124735689D;
			// 
			// xrTableCell22
			// 
			...
			this.xrTableCell22.Weight = 0.66845383999371444D;
			// 
			// xrTableCell23
			// 
			...
			this.xrTableCell23.Weight = 1.1785253151867727D;
			// 
			// xrTableCell24
			// 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Chietkhau]")});
			this.xrTableCell24.Multiline = true;
			this.xrTableCell24.Name = "xrTableCell24";
			this.xrTableCell24.StylePriority.UseBorders = false;
			this.xrTableCell24.StylePriority.UseTextAlignment = false;
			this.xrTableCell24.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopCenter;
			this.xrTableCell24.Weight = 0.55368881345714693D;
			// 
			// xrTableCell26
			// 
			...
			this.xrTableCell26.Weight = 1.1785242878238897D;
			// 
			// viewDataSource1
			// 
			...
			// Maphieu
			// 
			this.Maphieu.Description = "Parameter1";
			this.Maphieu.Name = "Maphieu";
			this.Maphieu.Type = typeof(global::System.Guid);
			this.Maphieu.ValueInfo = "00000000-0000-0000-0000-000000000000";
			...
			this.FilterString = "[Oid] = ?Maphieu";
			this.Font = new DevExpress.Drawing.DXFont("Arial", 9.75F);
			this.Margins = new DevExpress.Drawing.DXMargins(50F, 100F, 29.16667F, 100F);
